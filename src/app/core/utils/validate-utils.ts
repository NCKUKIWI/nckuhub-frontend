...
export class ValidateUtils {
    ...
    static inputLength(limitLength: number): ValidatorFn {
        return (control: FormControl): ValidatorResponse => {
            ...
            if (inputValue != null) {
                return inputValue.length <= limitLength
                    ? null
                    : {
                          error: {
    ...
    static requiredNotNull(control: FormControl): ValidatorResponse {
        return Validators.nullValidator(control) == null
            ? null
            : {
                  required: {
                      message: '必輸欄位',
    ...
    static requiredY(control: FormControl): ValidatorResponse {
        return Validators.required(control) == null && control.value === 'Y'
            ? null
            : {
                  required: {
                      message: '必輸欄位',
    ...
    static max(max: number): ValidatorFn {
        return (control: FormControl): ValidatorResponse => {
            return Validators.max(max)(control) == null
                ...
                : {
                      max: {
                          message: `最大數值為${max}, 輸入數值為${control.value}`,
                      },
                  };
        };
    }
    ...
    static maxLength(max: number): ValidatorFn {
        return (control: FormControl): ValidatorResponse => {
            return Validators.maxLength(max)(control) == null
                ? null
                : {
                      max: {
                          message: `最大長度為${max}, 輸入長度為${control.value.length}`,
                      },
                  };
        };
    }
    ...
    static min(min: number): ValidatorFn {
        return (control: FormControl): ValidatorResponse => {
            return Validators.min(min)(control) == null
                ...
                : {
                      min: {
                          message: `最小數值為${min}, 輸入數值為${control.value}`,
                      },
                  };
        };
    }
    ...
    static number(integer: number, decimal: number): ValidatorFn {
        return (control: FormControl): ValidatorResponse => {
            ...
            return control.value === null ||
                ...
                : {
                      regExp: {
                          message: `輸入格式為數字${integer}位，小數${decimal}位, 輸入數值為${control.value}`,
                      },
                  };
        };
    }
    ...
    static greaterThan(num: number): ValidatorFn {
        return (control: FormControl): ValidatorResponse => {
            ...
            return inputValue == null ||
                ...
                : {
                      greaterThan: {
                          message: `輸入值須大於${num}, 輸入數值為${control.value}`,
                      },
                  };
        };
    }
    ...
    static minLength(min: number): ValidatorFn {
        return (control: FormControl): ValidatorResponse => {
            return Validators.minLength(min)(control) == null
                ? null
                : {
                      minLength: {
                          message: `最小長度為${min}, 輸入長度為${control.value.length}`,
                      },
                  };
        };
    }
